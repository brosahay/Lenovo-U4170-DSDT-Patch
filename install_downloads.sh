...
EXCEPTIONS="Sensors|FakePCIID_Intel_GbX|FakePCIID_Intel_HDMI|BrcmPatchRAM|BrcmNonPatchRAM|BrcmNonPatchRAM2|BrcmBluetoothInjector|BrcmFirmwareData|USBInjectAll"
